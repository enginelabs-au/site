...
This post is the case study for **this repo** — the site you are reading. The client is Engine Labs, Sydney, which is to say me, on the same fixed scope, price band and handover terms I hold every other client to.
